							...
							<table class="table table-striped">
									<thead>
										<tr>
											...
											<th scope="col" class="border-0">Processing</th>
								...
								<div x-show="cSchedulingId" style="display: none">
									<div class="modal-background">
										<div @click.away="cSchedulingId = null" class="modal-dialog modal-dialog-centered modal" style="max-width: 700px">
											<div class="modal-content">
												...
												<td>
													@if ($data->action === 'dealing')
														<a href="{{ route('admin.projects.dealing', [$data->id ,'harian']) }}" 
															class="btn-sm btn-success">Dealing&nbsp;<i class="icon-copy fa fa-chevron-right" aria-hidden="true"></i></a>														
													@else
